<x-app-layout>
    <div class="p-6 max-w-4xl mx-auto">
        <div class="mb-6">
            ...
            <p class="text-gray-600 mt-2">Ubah data transaksi pembelian barang</p>
        </div>
            ...
            <form action="{{ route('expenses.update', $expense) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" 
                           name="purchase_price" 
                           id="purchase_price" 
                           value="{{ old('purchase_price', $expense->purchase_price) }}"
                           min="0"
                           step="0.01"
                ...
                <div class="mb-4">
                    ...
                    <div class="w-full border border-gray-300 rounded-lg px-4 py-2 bg-gray-50 text-gray-700 font-semibold">
                        Rp <span id="total-display">{{ number_format($expense->total, 0, ',', '.') }}</span>
                    </div>
                </div>
